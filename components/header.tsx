...
export function Header() {
  return (
    <header className="flex flex-wrap items-baseline justify-between gap-x-3 gap-y-1 border-b border-hn-line px-3 py-2 text-[12px]">
      <p className="m-0 min-w-0 text-hn-glow">
        <span className="text-hn-meta">$</span> david@world:<span className="text-hn-orange">~/notes</span>
      </p>
